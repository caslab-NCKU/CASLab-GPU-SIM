...
// demo config vars
//int iNumElements = 2097152;	// Length of float arrays to process (odd # for illustration)
int iNumElements = 209;	// Length of float arrays to process (odd # for illustration)
